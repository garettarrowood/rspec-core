...
require 'rspec/core/bisect/double_fork_runner'
...
module RSpec::Core
  RSpec.shared_examples_for "a bisect runner" do
    ...
    def with_runner(&block)
      in_current_dir do
        described_class.start(shell_command, &block)
      end
    end
  ...
  RSpec.shared_examples_for "a forking runner" do
    include_examples 'a bisect runner'
  ...
  RSpec.describe Bisect::ForkRunner do
    include_examples "a forking runner"
  end

  RSpec.describe Bisect::DoubleForkRunner do
    include_examples "a forking runner"
  end
end
